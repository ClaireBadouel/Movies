...
def test_movies_idx_post(client, formdata_correct=formdata_correct, formdata_incorrect_title=formdata_incorrect_title):
  # the endpoint returns the expected response : 
  ...
  formdata_correct_randomized['title'] = f"{formdata_correct_randomized['title']} - {rand_number}"
  response = client.post('/movies', data=formdata_correct_randomized, follow_redirects=True)
  ...
  formdata_incorrect_title_randomized['title'] = f"{formdata_incorrect_title_randomized['title']} - {rand_number}"
  response = client.post('/movies', data=formdata_incorrect_title_randomized, follow_redirects=True)
